...
def main():
    ...
    ap.add_argument("--circle", choices=["random","student","student_cpp","student2"], default="random")
    ap.add_argument("--square", choices=["random","student","student_cpp","student2"], default="random")
